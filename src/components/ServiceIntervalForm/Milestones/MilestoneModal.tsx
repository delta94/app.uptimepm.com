import { Modal, Form, Input, Row, Col, Switch, Icon, InputNumber } from 'antd';
...
export const MilestoneModal = forwardRef((props: IProps, ref: any) => {
  ...
  return (
    <Modal visible={props.visible} title="Add a new milestone" okText="Add" onCancel={props.onCancel} onOk={props.onCreate}>
