...
import { WorkOrder, WorkOrderStatusEnum, UserReference } from 'generated';
            ...
            <View style={[styles.header, styles.paddingLeft, styles.paddingRight]}>
              ...
              <View style={[styles.table]}>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={styles.tableCol4}>
                    <Text style={styles.tableCell}> {formatStatus(workOrder.status ? workOrder.status! : WorkOrderStatusEnum.Open)}</Text>
                  </View>
                  <View style={styles.tableCol4}>
                    <Text style={styles.tableCell}> {workOrder.reportedBy ? workOrder.reportedBy.firstName + ' ' + workOrder.reportedBy.lastName : ''}</Text>
                  </View>
                  <View style={styles.tableCol4}>
                    <Text style={styles.tableCell}> {formatAssignedTo(workOrder.assignedTo ? workOrder.assignedTo! : [])} </Text>
