...
class HorizontalNav extends React.Component<ISettingsContext> {
  getNavStyleSubMenuClass = (navStyle: string) => {
    switch (navStyle) {
      case NAV_STYLE_DEFAULT_HORIZONTAL:
        return 'upm-menu-horizontal upm-submenu-popup-curve';
      case NAV_STYLE_INSIDE_HEADER_HORIZONTAL:
        return 'upm-menu-horizontal upm-submenu-popup-curve upm-inside-submenu-popup-curve';
      case NAV_STYLE_BELOW_HEADER:
        return 'upm-menu-horizontal upm-submenu-popup-curve upm-below-submenu-popup-curve';
      case NAV_STYLE_ABOVE_HEADER:
        return 'upm-menu-horizontal upm-submenu-popup-curve upm-above-submenu-popup-curve';
      default:
        return 'upm-menu-horizontal';
    }
  };

  render() {
    const {
      values: { pathname, navStyle }
    } = this.props;
          ...
          return (
            <Menu defaultOpenKeys={[defaultOpenKeys]} selectedKeys={[selectedKeys]} mode="horizontal">
              {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, undefined, undefined) && (
                <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="main" title={<Trans defaults="Corporate">Corporate</Trans>}>
                  ...
                  {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Payment Plans'], 'View') && (
                    <Menu.Item key="corporate/paymentPlans">
                      <Link to="/corporate/paymentPlans">
                        <i className="icon icon-widgets" />
              ...
              {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="in-built-apps" title={<IntlMessages id="sidebar.inBuiltApp" />}>
              ...
              {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="components" title={<IntlMessages id="sidebar.components" />}>
                  <SubMenu
                    className="upm-menu-horizontal"
                    key="general"
                    title={
                      <span>
              ...
              {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="extraComponents" title={<IntlMessages id="sidebar.extraComponents" />}>
                  <SubMenu
                    className="upm-menu-horizontal"
                    key="editor"
                    title={
              ...
              {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="extensions" title={<IntlMessages id="sidebar.extensions" />}>
              ...
              {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="custom-views" title={<IntlMessages id="sidebar.customViews" />}>
                  <SubMenu
                    className="upm-menu-horizontal"
                    key="user-auth"
                    title={
...
export default withSettingsContext(HorizontalNav);
