...
interface HorizontalDarkState {
  searchText: string;
}

class HorizontalDark extends React.Component<ISettingsContext, HorizontalDarkState> {
  state = {
    searchText: '',
  };
  ...
  render() {
    ...
    return (
      <div className="upm-header-horizontal upm-header-horizontal-dark">
        ...
        <div className="upm-header-horizontal-nav upm-d-none upm-d-lg-block">
          <div className="upm-container">
...
export default withSettingsContext(HorizontalDark);
