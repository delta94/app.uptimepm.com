...
class BelowHeader extends React.Component<ISettingsContext, {}> {
  state = {
    searchText: '',
  };
  ...
  render() {
    ...
    return (
      <div className="upm-header-horizontal upm-header-horizontal-dark upm-below-header-horizontal">
...
export default withSettingsContext(BelowHeader);
