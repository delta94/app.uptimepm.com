...
interface HorizontalDefaultState {
  searchText: string;
}

class HorizontalDefault extends React.Component<ISettingsContext, HorizontalDefaultState> {
  state = {
    searchText: '',
  };
  ...
  render() {
    ...
    return (
      <div className="upm-header-horizontal">
        ...
        <Header className="upm-header-horizontal-main">
          <div className="upm-container">
            <div className="upm-header-horizontal-main-flex">
              ...
              <Link to="/" className="upm-d-block upm-d-lg-none upm-pointer upm-w-logo">
...
export default withSettingsContext(HorizontalDefault);
