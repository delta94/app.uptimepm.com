...
import { NAV_STYLE_NO_HEADER_EXPANDED_SIDEBAR, NAV_STYLE_NO_HEADER_MINI_SIDEBAR, THEME_TYPE_LITE, NAV_STYLE_FIXED } from 'constants/ThemeSetting';
...
class SidebarContent extends React.Component<ISettingsContext, {}> {
  getNoHeaderClass = (navStyle: string) => {
    if (navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR || navStyle === NAV_STYLE_NO_HEADER_EXPANDED_SIDEBAR) {
      return 'upm-no-header-notifications';
    }
    return '';
  };
  getNavStyleSubMenuClass = (navStyle: string) => {
    if (navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR) {
      return 'upm-no-header-submenu-popup';
    }
    return '';
  };
  ...
  render() {
    const {
      values: { themeType, navStyle, pathname },
    } = this.props;
    ...
    if (navStyle === NAV_STYLE_FIXED) {
      defaultOpenKeys = pathname.substr(1).split('/'); // Is it a mini collapsed? if so, then don't set any open keys
      selectedKeys = pathname
        .substr(1)
        .split('/')
        .concat([pathname.substr(1)]);
      // openKeys = pathname.substr(1).split('/');
    }
    // console.log('defaultOpenKeys', defaultOpenKeys);
    return (
      <CurrentUserConsumer>
        {(userContext: ICurrentUserContext) => {
          // console.log('*************** userContext.user.roles', userContext.user ? userContext.user.roles : []);
          return (
            <>
              <SidebarLogo />
              <div className="upm-sidebar-content">
                <div className={`upm-sidebar-notifications ${this.getNoHeaderClass(navStyle)}`} style={{ paddingRight: 0 }}>
                  <UserProfile />
                </div>
                <CustomScrollbars className="upm-layout-sider-scrollbar">
                  <Menu
                    // subMenuCloseDelay={5}
                    // onClick={item => console.log('clicked', item)}
                    onOpenChange={keys => {
                      // console.log('clicked open', keys);
                      // openKeys = keys;
                    }}
                    // openKeys={openKeys}
                    ...
                    mode="inline"
                  >
                    {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, undefined, undefined) && (
                      <MenuItemGroup key="corporate" className="upm-menu-group" title={<Trans defaults="Corporate">Corporate</Trans>}>
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Dashboard'], 'View') && (
                          <Menu.Item key="corporate/dashboard">
                        ...
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Clients'], 'View') && (
                          <Menu.Item key="corporate/clients">
                            <Link to="/corporate/clients">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Clients">Clients</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Office Locations'], 'View') && (
                          <Menu.Item key="corporate/office-locations">
                            <Link to="/corporate/office-locations">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Office Locations">Office Locations</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {/* {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Notifications'], 'View') && (
                          <Menu.Item key="corporate/notifications">
                            <Link to="/corporate/notifications">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Notifications">Notifications</Trans>
                            </Link>
                          </Menu.Item>
                        )} */}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Jobs'], 'View') && (
                          <Menu.Item key="corporate/jobs">
                            <Link to="/corporate/jobs">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Jobs">Jobs</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Inspection Templates'], 'View') && (
                          <Menu.Item key="corporate/inspection-templates">
                            <Link to="/corporate/inspection-templates">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Inspection Templates">Inspection Templates</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Inspection History'], 'View') && (
                          <Menu.Item key="corporate/inspection-history">
                            <Link to="/corporate/inspection-history">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Inspection History">Inspection History</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Service Intervals'], 'View') && (
                          <Menu.Item key="corporate/service-intervals">
                            <Link to="/corporate/service-intervals">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Service Intervals">Service Intervals</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Equipment'], 'View') && (
                          <Menu.Item key="corporate/equipment">
                            <Link to="/corporate/equipment">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Equipment">Equipment</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Dealers'], 'View') && (
                          <Menu.Item key="corporate/dealers">
                            <Link to="/corporate/dealers">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Dealers">Dealers</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Work Orders'], 'View') && (
                          <Menu.Item key="corporate/work-orders">
                            <Link to="/corporate/work-orders">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Work Orders">Work Orders</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Fluid Reports'], 'View') && (
                          <Menu.Item key="corporate/fluid-reports">
                            <Link to="/corporate/fluid-reports">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Fluid Reports">Fluid Reports</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Makes'], 'View') && (
                          <Menu.Item key="corporate/makes">
                            <Link to="/corporate/makes">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Makes">Makes</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Roles'], 'View') && (
                          <Menu.Item key="corporate/roles">
                            <Link to="/corporate/roles">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Roles">Roles</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Role Permissions'], 'View') && (
                          <Menu.Item key="corporate/role-permissions">
                            <Link to="/corporate/role-permissions">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Role Permissions">Role Permissions</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Users'], 'View') && (
                          <Menu.Item key="corporate/users">
                            <Link to="/corporate/users">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Users">Users</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Corporate, ['Payment Plans'], 'View') && (
                          <Menu.Item key="corporate/payment-plans">
                            <Link to="/corporate/payment-plans">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Payment Plans">Payment Plans</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                      </MenuItemGroup>
                    )}
                    {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, undefined, undefined) && (
                      <MenuItemGroup key="client" className="upm-menu-group" title={<Trans defaults="Client" />}>
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Dashboard'], 'View') && (
                          <Menu.Item key="client/dashboard">
                        ...
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Office Locations'], 'View') && (
                          <Menu.Item key="client/office-locations">
                            <Link to="/client/office-locations">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Office Locations">Office Locations</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {/* {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Notifications'], 'View') && (
                          <Menu.Item key="client/notifications">
                        ...
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Jobs'], 'View') && (
                          <Menu.Item key="client/jobs">
                            <Link to="/client/jobs">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Jobs">Jobs</Trans>
                            </Link>
                        ...
                        {/* {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Service Intervals'], 'View') && (
                          <Menu.Item key="client/service-intervals">
                            <Link to="/client/service-intervals">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Service Intervals">Service Intervals</Trans>
                            </Link>
                          </Menu.Item>
                        )} */}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Equipment'], 'View') && (
                          <Menu.Item key="client/equipment">
                            <Link to="/client/equipment">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Equipment">Equipment</Trans>
                            </Link>
                          </Menu.Item>
                        ...
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Dealers'], 'View') && (
                          <Menu.Item key="client/dealers">
                            <Link to="/client/dealers">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Dealers">Dealers</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Inspection Templates'], 'View') && (
                          <Menu.Item key="client/inspection-templates">
                            <Link to="/client/inspection-templates">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Inspection Templates">Inspection Templates</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Inspection History'], 'View') && (
                          <Menu.Item key="client/inspection-history">
                            <Link to="/client/inspection-history">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Inspection History">Inspection History</Trans>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Work Orders'], 'View') && (
                          <Menu.Item key="client/work-orders">
                            <Link to="/client/work-orders">
                              <i className="icon icon-widgets" />
                              <Badge className="badge-work-orders" count={userContext.notificationCount}>
                                <Trans defaults="Work Orders">Work Orders</Trans>
                              </Badge>
                            </Link>
                          </Menu.Item>
                        )}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Fluid Reports'], 'View') && (
                          <Menu.Item key="client/fluid-reports">
                            <Link to="/client/fluid-reports">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Fluid Reports">Fluid Reports</Trans>
                            </Link>
                          </Menu.Item>
                        ...
                        {/* {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Parts'], 'View') && (
                          <Menu.Item key="client/parts">
                            <Link to="/client/parts">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Parts">Parts</Trans>
                            </Link>
                          </Menu.Item>
                        )}

                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Makes'], 'View') && (
                          <Menu.Item key="client/makes">
                            <Link to="/client/makes">
                              <i className="icon icon-widgets" />
                              <Trans defaults="Makes">Makes</Trans>
                            </Link>
                          </Menu.Item>
                        )} */}
                        {allowed(userContext.user, ['Administrator'], RoleTypeEnum.Client, ['Users'], 'View') && (
                          <Menu.Item key="client/users">
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="main" className="upm-menu-group" title={<IntlMessages id="sidebar.main" />}>
                        <SubMenu
                          key="dashboard"
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="in-built-apps" className="upm-menu-group" title={<IntlMessages id="sidebar.inBuiltApp" />}>
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="social-apps" className="upm-menu-group" title={<IntlMessages id="sidebar.social" />}>
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="components" className="upm-menu-group" title={<IntlMessages id="sidebar.components" />}>
                        <SubMenu
                          key="general"
                          className={this.getNavStyleSubMenuClass(navStyle)}
                          title={
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="extraComponents" className="upm-menu-group" title={<IntlMessages id="sidebar.extraComponents" />}>
                        <SubMenu
                          key="editor"
                          className={this.getNavStyleSubMenuClass(navStyle)}
                          title={
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="extensions" className="upm-menu-group" title={<IntlMessages id="sidebar.extensions" />}>
                        <SubMenu
                          key="map"
                          className={this.getNavStyleSubMenuClass(navStyle)}
                          title={
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="custom-views" className="upm-menu-group" title={<IntlMessages id="sidebar.customViews" />}>
                        <SubMenu
                          key="user-auth"
                          className={this.getNavStyleSubMenuClass(navStyle)}
                          title={
                    ...
                    {allowed(userContext.user, ['Developer'], RoleTypeEnum.Developer, undefined, undefined) && (
                      <MenuItemGroup key="documents" className="upm-menu-group" title={<IntlMessages id="sidebar.documents" />}>
...
export default withSettingsContext(SidebarContent);
